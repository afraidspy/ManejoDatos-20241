...
class File(IAlmacenamiento):
    ...
    def guardar_articulo(self,articulo):
       try:
            with open(self.__nombre,'a',encoding = 'utf-8') as f:
                        print(articulo)
...
carrito = CarritoCompras(user, File("info_art.csv"))
